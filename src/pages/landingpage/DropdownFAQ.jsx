        ...
        <Dropdown.Menu style={{ ...menuStyle, ...customStyle }}>
          <div className="dropdown-item">
            ...
            <ul>
              ...
              <li>
                Không được uống rượu, bia, chơi cờ bạc, sử dụng các chất kích
                thích và chất cấm.
              </li>
              <li>Không được nấu ăn trong ký túc xá.</li>
              <li>
                Không được đưa người lạ không ở trong ký túc xá vào phòng sau
                giờ giới nghiêm.
              </li>
              <li>
            ...
            <h6>
              Tất cả các lỗi vi phạm đều bị trừ dựa trên điểm uy tín dựa trên
              mức độ lỗi vi phạm.
            </h6>
          </div>
        </Dropdown.Menu>
        ...
        <Dropdown.Menu style={{ ...menuStyle, ...customStyle }}>
          <div className="dropdown-item">
            <h6>
              ...
              trong những yếu tố để tạo ra môi trường KTX văn minh và lành mạnh
              hơn
            </h6>
            <ul>
              <li>
                Điểm uy tín là tiêu chí để đánh giá ý thức của sinh viên khi sử
                dụng dịch vụ ký túc xá.
              </li>
              <li>
              ...
              <li>
                Điểm uy tín sẽ được tăng, giảm tương ứng theo các quy định đã
                được đề ra trong nội quy KTX.
              </li>
              <li>
                Điểm uy tín là một trong những tiêu chí được dùng để xét duyệt
                xem sinh viên có được sử dụng ký túc xá trong kỳ hay không.
              </li>
              <li>Giữ gìn vệ sinh chung và đổ rác trước 9 giờ sáng.</li>
            </ul>
            <h6>
